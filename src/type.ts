...
export type LookUp<U extends { type: string }, T> = U extends { type: T } ? U : never;
...
export namespace IJiraService {
  ...
  export interface IGetCommentOutput extends ICommonPaginationOutput {
     ...
     * @title comments
     */
    comments: (Pick<IJiraService.Comment, "id" | "author" | "created" | "updated" | "updateAuthor"> & {
      /**
  ...
  export interface IGetCommentInput extends IJiraService.__IGetCommentInput {}

  export interface __IGetCommentInput extends ICommonPaginationInput {
    /**
  ...
  export interface IDeleteCommentInput extends IJiraService.__IDeleteCommentInput {}

  export interface __IDeleteCommentInput {
    /**
     * This connector doesn't matter the key or ID of the issue.
     * If you hand over one of them, you can use it to look up.
     *
  ...
  export interface ICreateCommentByMarkdownInput extends Omit<ICreateCommentInput, "body"> {
    /**
     * @title body of comment
     */
    body: Omit<Comment["body"], "content"> & {
      /**
  ...
  export interface __ICreateCommentByMarkdownInput extends Omit<ICreateCommentInput, "body"> {
    /**
     * @title body of comment
     */
    body: Omit<Comment["body"], "content"> & {
  ...
  export interface IUpdateStatusInput extends IJiraService.__IUpdateStatusInput {}

  export interface __IUpdateStatusInput {
    /**
     * This connector doesn't matter the key or ID of the issue.
     * If you hand over one of them, you can use it to look up.
     *
  ...
  export interface IGetTransitionInput extends IJiraService.__IGetTransitionInput {}
  export interface __IGetTransitionInput {
    /**
     * This connector doesn't matter the key or ID of the issue.
     * If you hand over one of them, you can use it to look up.
     *
  ...
  export interface IUnAssignInput extends IJiraService.__IUnAssignInput {}

  export type __IUnAssignInput = Omit<__IAssignInput, "asigneeId">;

  export interface IAssignInput extends IJiraService.__IAssignInput {}

  export interface __IAssignInput {
    /**
     * @title ID of issue
     */
    issueId: Issue["id"];
  ...
  export interface IUpdateCommentByMarkdownInput extends Omit<IUpdateCommentInput, "body"> {
    /**
     * @title body of comment
     */
    body: Omit<Comment["body"], "content"> & {
  ...
  export interface IUpdateCommentInput extends Partial<Omit<ICreateCommentInput, "body">> {
    /**
     * This connector doesn't matter the key or ID of the issue.
     * If you hand over one of them, you can use it to look up.
     *
  ...
  export interface IUpdateIssueInput extends IJiraService.__IUpdateIssueInput {}

  /**
   * @title Issue update Conditions
   */
  export interface __IUpdateIssueInput extends Partial<Omit<ICreateIssueInput, "fields">> {
    /**
  ...
  export interface ICreateIssueByMarkdownInput {
    /**
     * @title fields
     *
  ...
  export type ICreateIssueInputWithBasicAuth = IJiraService.ICreateIssueInput;
  ...
  export interface IGetIssueLabelInput extends IJiraService.__IGetIssueLabelInput {}

  export interface __IGetIssueLabelInput extends ICommonPaginationInput {}

  export type IGetIssuePriorityOutput = Pick<Priority, "id" | "name">[];

  export interface IGetIssuePriorityInput extends IJiraService.__IGetIssuePriorityInput {}

  export interface __IGetIssuePriorityInput {}
  ...
  export interface IGetIssueStatusInput extends IJiraService.__IGetIssueStatusInput {}

  export interface __IGetIssueStatusInput {
    /**
  ...
  export interface IGetIssueDetailOutput extends Issue {
     ...
     */
    fields: Omit<DetailedIssueField, "comment" | "description"> & {
      /**
  ...
  export type HeadingNodeWithoutMarks = {
     ...
     * @title content
     */
    content: (EmojiNode | HardBreakNode | InlineCardNode | MentionNode | Omit<Text, "marks">)[];
  ...
  export type PanelNode = {
     ...
     * @title content
     */
    content: (ListNode | HeadingNodeWithoutMarks | ParagraphContentWithoutNoMarks)[];
  };
  ...
  export type TableCellNode = {
    ...
    attrs?: {
       ...
       * @title colwidth
       */
      colwidth?: Array<number & tags.Type<"uint64">> & tags.MinItems<3> & tags.MaxItems<3>;
   ...
   * @title inlineNode
   */
  export type InlineNode = EmojiNode | HardBreakNode | InlineCardNode | MentionNode | Text;

  export interface IGetIssueDetailInput extends IJiraService.__IGetIssueDetailInput {}

  export interface __IGetIssueDetailInput {
    /**
     * This connector doesn't matter the key or ID of the issue.
     * If you hand over one of them, you can use it to look up.
     *
  ...
  export interface IGetIssueInputByBasicAuth extends IJiraService.__IGetIssueInputByBasicAuth {}

  export interface __IGetIssueInputByBasicAuth extends ICommonPaginationInput, IGetIssueCommonRequestInput {}

  export interface IGetIssueInputBySecretKey extends ICommonPaginationInput, IGetIssueCommonRequestInput {}

  export type IGetIssueAssignableOutput = Pick<User, "accountId" | "displayName" | "active">[];

  export interface IGetIssueAssignableInput extends IJiraService.__IGetIssueAssignableInput {}

  export interface __IGetIssueAssignableInput extends ICommonPaginationInput {
    /**
     * @title key of project
     *
  ...
  export type IGetProjectAssignableOutput = Pick<User, "accountId" | "displayName" | "active">[];

  export type IGetStatusOutput = Pick<Status, "id" | "name" | "statusCategory" | "description" | "untranslatedName">[];

  export type IGetStatusCategoryOutput = StatusCategory[];

  export interface IGetProjectAssignableInput extends IJiraService.__IGetProjectAssignableInput {}

  export interface __IGetProjectAssignableInput extends ICommonPaginationInput {
    /**
     * @title key of project
     *
     * It refers to the key of the project to search for the user to be assigned.
  ...
  export interface IGetIssueTypeInput extends IJiraService.__IGetIssueTypeInput {}

  export interface __IGetIssueTypeInput {
    /**
     * @title id of project
     */
    projectId: Project["id"];
  ...
  export interface IGetProjectInputByBasicAuth extends IJiraService.__IGetProjectInputByBasicAuth {}

  export interface __IGetProjectInputByBasicAuth extends ICommonPaginationInput {
    /**
    ...
    orderBy?:
      ...
      | tags.Constant<
        ...
        >
      | tags.Constant<"name", { title: "name"; description: "Sorts by project name." }>;
  }

  export interface IGetProjectInputBySecretKey extends ICommonPaginationInput {
    /**
     * Order the results by a field.
     *
     * - issueCount : Sorts by the total number of issues in each project.
  ...
  export interface IssueField {
     ...
     * @title status
     */
    status: Pick<Status, "id" | "name" | "description" | "statusCategory" | "untranslatedName">;
